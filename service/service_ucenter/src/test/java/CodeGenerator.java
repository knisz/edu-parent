...
public class CodeGenerator {
    ...
    public void run() {
        ...
        //gc.setOutputDir(projectPath + "/src/main/java");  //相对路径法
        gc.setOutputDir("C:\\Users\\Zerger\\IdeaProjects\\school_project\\service\\service_ucenter" + "/src/main/java");    //绝对路径法，更好 ***
        ...
        strategy.setInclude("ucenter_member"); //可以通过逗号加多张表
